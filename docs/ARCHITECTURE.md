...
> Version 2.0 · Last updated 2026-09-06 · v3.70
...
| Testing | Jest + RTL | 30 + 16 | **728 tests across 45 suites** — they gate `npm run build` locally |
...
__tests__/                  45 suites, 728 tests — gate the build
```
