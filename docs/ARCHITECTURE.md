...
> Version 2.0 · Last updated 2026-09-06 · v3.71
...
| Testing | Jest + RTL | 30 + 16 | **734 tests across 46 suites** — they gate `npm run build` locally |
...
__tests__/                  46 suites, 734 tests — gate the build
```
