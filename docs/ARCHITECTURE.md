...
> Version 2.0 · Last updated 2026-09-06 · v3.74
...
| Testing | Jest + RTL | 30 + 16 | **756 tests across 46 suites** — they gate `npm run build` locally |
...
__tests__/                  46 suites, 756 tests — gate the build
```
