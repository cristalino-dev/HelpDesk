  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }}>
        ...
        <span style={{ fontWeight: 700, color: T.text, fontSize: "1rem" }}>מערכת helpdesk</span>
      </div>
      ...
      <div style={{
        ...
        maxWidth: 480,
        width: "100%",
        boxShadow: `0 8px 40px ${T.shadow2}`,
        ...
        {/* ── Loading ── */}
        {state === "loading" && (
          <div style={{ padding: "20px 0", color: T.inkFaint }}>
            <div style={{ width: 36, height: 36, border: `3px solid ${T.line}`, borderTopColor: T.text, borderRadius: "50%", margin: "0 auto 16px", animation: "spin 0.8s linear infinite" }} />
        ...
        {state === "notFound" && (
          <>
            ...
            <h2 style={{ margin: "0 0 10px", color: T.text, fontSize: "1.2rem" }}>הפנייה לא נמצאה</h2>
            <p style={{ margin: "0 0 24px", color: T.inkMuted, fontSize: "0.9rem" }}>הקישור אינו תקין או שהפנייה נמחקה.</p>
          ...
          <>
            ...
            {isUpdate && (
              <div style={{
                ...
                fontSize: "0.78rem", fontWeight: 600, color: T.amberFgDeep,
              }}>
                <span>✏️</span>
            ...
            <p style={{ margin: "0 0 6px", color: T.ink, fontSize: "0.95rem", fontWeight: 500 }}>
              {ticket.subject}
            </p>
            <p style={{ margin: "0 0 28px", color: T.inkFaint, fontSize: "0.82rem" }}>
            ...
            {/* Star label */}
            <div style={{ height: 22, marginBottom: 20, fontSize: "0.88rem", fontWeight: 600, color: active >= 4 ? T.greenSFg : active >= 3 ? T.amberFg : active >= 1 ? T.redFg : "transparent" }}>
            ...
            <textarea
              ...
              style={{
                ...
                padding: "10px 14px", fontSize: "0.88rem", color: T.ink,
                resize: "vertical", fontFamily: "inherit", direction: "rtl",
                outline: "none", marginBottom: 6,
              }}
            />

            {error && <p style={{ margin: "0 0 12px", color: T.redFg, fontSize: "0.82rem" }}>{error}</p>}
            ...
            <button
              ...
              style={{
                ...
                background: state === "submitting" ? T.inkFaint : isUpdate
                  ? T.inverseBg
                  : `linear-gradient(135deg, ${T.greenSFg}, ${T.greenSFgDeep})`,
                color: T.inverseText, border: "none", borderRadius: 10,
                fontWeight: 800, fontSize: "0.95rem",
                cursor: state === "submitting" ? "default" : "pointer",
                marginTop: 8,
                boxShadow: state === "submitting" ? "none"
                  : isUpdate ? `0 4px 14px ${T.overlay}`
                  : `0 4px 14px ${T.greenSBorder}`,
        ...
        {state === "done" && (
          <>
            ...
            <h2 style={{ margin: "0 0 10px", color: T.greenSFgDeep, fontSize: "1.35rem", fontWeight: 800 }}>תודה רבה!</h2>
            <p style={{ margin: "0 0 6px", color: T.ink, fontSize: "0.95rem" }}>
            ...
            <Link href="/dashboard" style={{ display: "inline-block", padding: "10px 24px", background: T.inverseBg, color: T.inverseText, textDecoration: "none", borderRadius: 9, fontWeight: 700, fontSize: "0.88rem" }}>
              חזרה ללוח הבקרה
            </Link>
          </>
        )}
        ...
        {state === "updated" && (
          <>
            <div style={{ fontSize: 52, marginBottom: 16, animation: "pop 0.3s ease" }}>✅</div>
            <h2 style={{ margin: "0 0 10px", color: T.pillBlueFg, fontSize: "1.35rem", fontWeight: 800 }}>הביקורת עודכנה!</h2>
            <p style={{ margin: "0 0 6px", color: T.ink, fontSize: "0.95rem" }}>
      ...
      <p style={{ marginTop: 24, color: T.inkFaint, fontSize: "0.78rem" }}>
