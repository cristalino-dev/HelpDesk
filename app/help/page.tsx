        ...
        <section id="dashboard" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <Card>
            ...
            <FieldList items={[
              ...
              { label: "סגירת פנייה",      desc: 'העבירו את העכבר מעל פנייה פעילה — כפתור "סגור פנייה" יופיע בצד שמאל של הכרטיס' },
              { label: "👥 משתתף",          desc: "כשהצוות מאחד את פנייתכם עם פנייה של עובד אחר באותו נושא, הפנייה המשותפת מופיעה בלוח שלכם עם התגית משתתף. אתם רואים אותה, כותבים בשיחה ומקבלים עדכונים עליה; את הסגירה עושה מי שפתח אותה" },
              { label: "🔗 מוזגה",          desc: "פנייה שהצוות איחד עם פנייה אחרת באותו נושא. היא סגורה, וההודעות והקבצים שלה עברו לפנייה שמופיעה בתגית — שם נמשך הטיפול. תקבלו על כך גם מייל" },
              { label: "גבול צבעוני",      desc: "הפס הצבעוני בצד ימין של כל פנייה מציין את רמת הדחיפות" },
              { label: "ימי עסקים",       desc: "ליד כל פנייה מוצגת כמה ימי עסקים חלפו מאז פתיחתה (לדוגמה: יע 3). ימי עסקים: ראשון–חמישי; שישי ושבת אינם נספרים. פנייה סגורה מציגה כמה ימי עסקים נמשך הטיפול." },
        ...
        <section id="new-ticket" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <Card>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              <FieldGuideItem label="קטגוריה" desc={<>בחרו את הקטגוריה המתאימה לבעיה: <Strong>חומרה</Strong>, <Strong>תוכנה</Strong>, <Strong>רשת</Strong>, <Strong>מדפסת</Strong>, <Strong>עובד חדש</Strong>, <Strong>סגירת משתמש</Strong>, <Strong>אחר</Strong>. רשימת הקטגוריות מנוהלת על ידי צוות התמיכה ועשויה להתעדכן.</>} />
              ...
              <FieldGuideItem label="סגירת משתמש" desc={<>בחירת הקטגוריה <Strong>סגירת משתמש</Strong> פותחת את הפנייה עם רשימת החזרה מלאה — כל פריטי הציוד וגם החשבונות (Gmail, Zoho, קומקס). הטכנאי מסמן כל פריט שהוחזר או שנסגר, ומסיר פריטים שאינם רלוונטיים. <Strong>לא ניתן לסגור את הפנייה עד שכל הפריטים מסומנים.</Strong></>} />
