        ...
        <section id="new-ticket" style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <Card>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
              ...
              <FieldGuideItem label="קטגוריה" desc={<>בחרו את הקטגוריה המתאימה לבעיה: <Strong>חומרה</Strong>, <Strong>תוכנה</Strong>, <Strong>רשת</Strong>, <Strong>מדפסת</Strong>, <Strong>עובד חדש</Strong>, <Strong>עובד עוזב</Strong>, <Strong>אחר</Strong>. רשימת הקטגוריות מנוהלת על ידי צוות התמיכה ועשויה להתעדכן.</>} />
              ...
              <FieldGuideItem label="עובד עוזב" desc={<>בחירת הקטגוריה <Strong>עובד עוזב</Strong> פותחת את הפנייה עם רשימת החזרה מלאה — כל פריטי הציוד וגם החשבונות (Gmail, Zoho, קומקס). הטכנאי מסמן כל פריט שהוחזר או שנסגר, ומסיר פריטים שאינם רלוונטיים. <Strong>לא ניתן לסגור את הפנייה עד שכל הפריטים מסומנים.</Strong></>} />
