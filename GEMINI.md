...
- **Tests:** Jest 30 + React Testing Library 16 — **1,417 tests across 84 suites**, gating `npm run build` locally (the server deploy runs `next build` directly, so jest is not a server-side gate).
