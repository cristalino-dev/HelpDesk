...
> **Current version: 3.70** · Updated 2026-09-06
...
- **Tests:** Jest 30 + React Testing Library 16 — **728 tests across 45 suites**, gating `npm run build` locally (the server deploy runs `next build` directly, so jest is not a server-side gate).
...
*Production build v3.70 — updated 2026-09-06.*
