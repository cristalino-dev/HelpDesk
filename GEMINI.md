...
> **Current version: 3.73** · Updated 2026-09-06
...
- **Tests:** Jest 30 + React Testing Library 16 — **741 tests across 46 suites**, gating `npm run build` locally (the server deploy runs `next build` directly, so jest is not a server-side gate).
...
*Production build v3.73 — updated 2026-09-06.*
