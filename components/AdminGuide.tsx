  ...
  return (
    <>
            ...
            <Section icon="🔎" title="מסך פנייה מלאה — /tickets/[id]">
              <p style={{ fontSize: "0.875rem", color: T.inkMuted, lineHeight: 1.7, marginBottom: 14 }}>
                מסך מפורט לפנייה בודדת. כולל את כל המידע, הערות הצוות וקבצים מצורפים.
              </p>
              <FeatureList items={[
                "צפייה בכל שדות הפנייה: נושא, תיאור, קטגוריה, פלטפורמה, דחיפות, סטטוס",
                "עריכת כל שדה — לחצו ✏️ עריכה בפינה",
                "תמונות וקבצים מצורפים (PDF ו-Office — להורדה)",
                "ציר הערות טכנאי עם שם הכותב ותאריך",
                "הוספת הערה חדשה עם צירוף קבצים והדבקת תמונות",
            ...
            <Section icon="🔗" title="מיזוג פניות">
              <p style={{ fontSize: "0.875rem", color: T.inkMuted, lineHeight: 1.7, marginBottom: 14 }}>
                כשאותה בעיה הגיעה יותר מפעם אחת — פנייה ואחריה מייל, שני מיילים, או כמה עובדים שדיווחו על אותה תקלה —
                ממזגים אותן לפנייה אחת.
              </p>
              <Steps items={[
                <>ממסך הפנייה: <strong>🔗 מיזוג</strong> והקלדת מספר הפנייה השנייה (למשל HDTC-512). מדף הפניות: סמנו שתיים או יותר ולחצו <strong>🔗 מיזוג</strong> בסרגל</>,
                <>בחרו את הפנייה <strong>שנשארת</strong> — כברירת מחדל הוותיקה ביותר</>,
                <>בדקו את הסיכום — מי יתווסף כמשתתף, ואם יש סיבה שהמיזוג לא יתאפשר</>,
                <>לחצו <strong>מזג לתוך …</strong></>,
              ]} />
              <FeatureList items={[
                "ההודעות, ההערות והקבצים של הפניות הממוזגות עוברים לפנייה שנשארת, לפי סדר הזמנים",
                "בפנייה שנשארת נוספת הערה פנימית עם הנושא, הפותח והתיאור של כל פנייה שמוזגה",
                "הפניות הממוזגות נסגרות, מציגות לאן מוזגו, ואי אפשר עוד לערוך אותן, לפתוח אותן מחדש או לכתוב בהן",
                "מי שפתח פנייה שמוזגה הופך למשתתף בפנייה שנשארת: רואה אותה בלוח שלו, כותב בשיחה ומקבל עדכונים — ומקבל מייל שמסביר לאן עברה פנייתו",
                "מענה במייל למספר הפנייה הישן מגיע לפנייה שנשארת",
                "פנייה עם רשימת ציוד חייבת להיות הפנייה שנשארת",
                "הדוחות אינם סופרים פניות שמוזגו — אותה בעיה לא נספרת פעמיים",
                "ניתן להסיר משתתף מתוך מסך הפנייה (✕ ליד שמו)",
              ]} />
              <Note>
                <strong>לא ניתן לבטל מיזוג.</strong> סגירה, פתיחה מחדש ודירוג השירות נשארים בידי מגיש הפנייה בלבד — לא בידי המשתתפים.
              </Note>
            </Section>
            ...
            <Section icon="📝" title="הערות טכנאי">
              ...
              <FeatureList items={[
                ...
                "ניתן להדביק תמונות (Ctrl+V) או לגרור קבצים — יצורפו לפנייה",
            ...
            <Section icon="📜" title="היסטוריית שינויים (ציר זמן)">
              ...
              <FeatureList items={[
                ...
                "מיזוג — בפנייה שמוזגה: לאן מוזגה; בפנייה שנשארת: אילו פניות מוזגו לתוכה ואילו משתתפים נוספו או הוסרו",
            ...
            <Section icon="📧" title="מערכת המיילים">
              <FeatureList items={[
                ...
                "כל המיילים נשלחים מ-noreply_helpdesk@cristalino.co.il — לא עונים אליה; מגיבים דרך הכפתור שבמייל",
              ]} />
            </Section>
